        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            <div className="glass-card p-6 rounded-2xl relative">
              <CursorPersona name="Sarah M." role="SDR" color="green" className="absolute -bottom-3 -left-3" />
            ...
            <div className="glass-card p-6 rounded-2xl relative">
              <CursorPersona name="Mike R." role="Ops Lead" color="blue" className="absolute top-4 -left-3" />
