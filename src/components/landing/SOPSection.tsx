      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 glass-card p-8 rounded-3xl relative">
              <CursorPersona name="Alex T." role="Product" color="purple" className="absolute -top-3 -left-3" />
            ...
            <div className="space-y-6">
              ...
              <div className="glass-card p-6 rounded-2xl relative">
                <CursorPersona name="Sarah M." role="Sales" color="blue" className="absolute -bottom-3 -right-3" />
              ...
              {/* Owners card */}
              <div className="glass-card p-6 rounded-2xl relative">
                <CursorPersona name="Mike R." role="Ops" color="green" className="absolute top-4 -right-3" />
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center">
