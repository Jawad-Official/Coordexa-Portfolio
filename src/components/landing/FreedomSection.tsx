    ...
    >
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="glass-card p-8 md:p-12 rounded-3xl max-w-4xl mx-auto relative">
            <CursorPersona name="Jennifer K." role="CEO" color="orange" className="absolute top-6 -left-3" />
            {/* Status banner */}
