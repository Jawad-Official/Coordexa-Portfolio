...
export const CTASection = () => {
  ...
  return (
    <section id="waitlist-section" className="pt-[150px] pb-[6px] section-dark relative overflow-hidden">
      {/* Glow effects */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 shadow-[0_0_24px_0_rgba(56,143,255,0.7)]">
          ...
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-serif text-white mb-6 mt-[40px]">
            Ready to build a
            <br />
            ...
            {[
              {
                ...
                persona: { name: "Sarah M.", role: "Sales", color: "blue" as const, position: "top-left" },
              },
              {
                title: "AI-Powered SOPs",
                desc: "Generate processes automatically",
                persona: { name: "Alex T.", role: "Product", color: "purple" as const, position: "bottom-right" },
              },
              {
              ...
              >
                {feature.persona && (
                  <CursorPersona 
                    name={feature.persona.name} 
                    role={feature.persona.role} 
                    color={feature.persona.color}
                    className={`absolute ${
                      feature.persona.position === "top-left" ? "-top-3 -left-3" :
                      feature.persona.position === "top-right" ? "-top-3 -right-3" :
                      feature.persona.position === "bottom-left" ? "-bottom-3 -left-3" :
                      "-bottom-3 -right-3"
                    }`}
                  />
                )}
      ...
      <div className="container mx-auto px-6 relative z-10 mt-20">
        <div className="max-w-4xl mx-auto text-center pt-[15px]">
          <a 
